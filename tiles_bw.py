...
def main():
    ...
    for line in range(10):
            pos = write_tile(conversion_cost='wasteland', pos=pos, canvas=c)

    for line in range(5):
            pos = write_tile(conversion_cost='water', pos=pos, canvas=c)

    for line in range(5):
            pos = write_tile(conversion_cost='mountains', pos=pos, canvas=c)
...
def write_tile(values=None, conversion_cost=None, front_img=None, back_img=None, pos=None, canvas=None):
    ...
    if values is not None:
        table = Table(values, style=[('TEXTCOLOR', (0,0), (1,2), black),
                                     ('SIZE', (0,0), (1,2), 14)])
